...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/images/core-features/tasks/task-sharing.png" alt="alt_text" title="image_tooltip" width="40%" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/images/core-features/tasks/auto-approve.png" alt="alt_text" title="image_tooltip" width="30%" />
</div>
