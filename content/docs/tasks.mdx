...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/images/core-features/tasks/task-sharing.png" alt="alt_text" title="image_tooltip" width="50%" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/images/core-features/tasks/auto-approve.png" alt="alt_text" title="image_tooltip" width="40%" />
</div>
...
| **Execute** | Manages dependencies, runs builds, executes tests, starts dev servers, and performs system operations. |
| **Use MCP** | Interacts with databases, APIs, and other external services to extend its capabilities through MCP server. |
| **Retry Logic** | Automatically retries failed commands, code changes, and dependency installations using different strategies. |
...
- Setting a reasonable maximum request limit (suggest to start with 3)
...
Advanced Settings include Developer Mode to allow configur Pochi's behavior with advanced options to customize your development workflow and debugging experience.
